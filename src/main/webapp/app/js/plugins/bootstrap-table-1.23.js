(function (global, factory) {
  ...
  */
  ...
  var BootstrapTable = /*#__PURE__*/function () {
    ...
    return _createClass(BootstrapTable, [{
      ...
      value: function initConstants() {
        ...
        this.constants.theme = $$q.fn.bootstrapTable_1_23.theme;
        this.constants.dataToggle = this.constants.html.dataToggle || 'data-toggle';

        // init iconsPrefix and icons
        var iconsPrefix = Utils.getIconsPrefix($$q.fn.bootstrapTable_1_23.theme);
        if (typeof opts.icons === 'string') {
          opts.icons = Utils.calculateObjectValue(null, opts.icons);
        }
        opts.iconsPrefix = opts.iconsPrefix || $$q.fn.bootstrapTable_1_23.defaults.iconsPrefix || iconsPrefix;
        opts.icons = Object.assign(Utils.getIcons(opts.iconsPrefix), $$q.fn.bootstrapTable_1_23.defaults.icons, opts.icons);
      ...
      value: function initLocale() {
        if (this.options.locale) {
          var locales = $$q.fn.bootstrapTable_1_23.locales;
        ...
        this.$header.find('tr').each(function (i, el) {
          ...
          $tr.find('th').each(function (i, el) {
            ...
            for (var key in _data) {
              if ($$q.fn.bootstrapTable_1_23.columnDefaults.hasOwnProperty(key)) {
                delete _data[key];
              }
            }
      ...
      value: function initHeader() {
        ...
        this.options.columns.forEach(function (columns, i) {
          ...
          columns.forEach(function (column, j) {
            ...
            {	style += Utils.sprintf('min-width: %s; ', column.minWidth+unitWidth); }
            if(column.maxWidth!=undefined)
            {	style += Utils.sprintf('max-width: %s; ', column.maxWidth+unitWidth); }
            //End extend
      ...
      //TODO @EXTEND Onofre
        html = ["<div id=\""+this.options.toolbarName+"\" class=\"toolbar-name ".concat(['columns', "columns-".concat(opts.buttonsAlign), this.constants.classes.buttonsGroup, "".concat(this.constants.classes.pull, "-").concat(opts.buttonsAlign)].join(' '), "\">")];
        //
      ...
      value: function resetView(params) {
        ...
        if( this.options.heightVh)
        {
        	this.$tableContainer.css('height', this.options.heightVh + 'vh');
        }
        //end
  ...
  $$q.fn.bootstrapTable_1_23 = function (option) {
  ...
  $$q.fn.bootstrapTable_1_23.Constructor = BootstrapTable;
  $$q.fn.bootstrapTable_1_23.theme = Constants.THEME;
  $$q.fn.bootstrapTable_1_23.VERSION = Constants.VERSION;
  $$q.fn.bootstrapTable_1_23.defaults = BootstrapTable.DEFAULTS;
  $$q.fn.bootstrapTable_1_23.columnDefaults = BootstrapTable.COLUMN_DEFAULTS;
  $$q.fn.bootstrapTable_1_23.events = BootstrapTable.EVENTS;
  $$q.fn.bootstrapTable_1_23.locales = BootstrapTable.LOCALES;
  $$q.fn.bootstrapTable_1_23.methods = BootstrapTable.METHODS;
  $$q.fn.bootstrapTable_1_23.utils = Utils;

  // BOOTSTRAP TABLE INIT
  // =======================

  $$q(function () {
    $$q('[data-toggle="table"]').bootstrapTable_1_23();
  });
