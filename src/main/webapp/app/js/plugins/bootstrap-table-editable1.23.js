(function (global, factory) {
	...
	*/
	...
	var Utils = $.fn.bootstrapTable_1_23.utils;
	$.extend($.fn.bootstrapTable_1_23.defaults, {
	  editable: true,
	...
	$.extend($.fn.bootstrapTable_1_23.Constructor.EVENTS, {
	      ...
	      $.each(this.columns, function (i, column) {
	        ...
	        column.formatter = function (value, row, index) {
	          ...
	          if (_dont_edit_formatter === false) 
	          {
	        	...
	        	//@TODO @GPO @ADM Modificado
	        	  return ['<a href="javascript:void(0)"',
                      ' data-name="' + column.field + '"',
                      ' data-pk="' + app[editableOptions['data-pk']](result,row,column.field) + '"',  
                      ' data-value="' + result + '"',
                      ' id="' + app[editableOptions['data-id']](result,row,column.field) + '"', 		
	    ...
	    value: function initBody(fixedScroll) {
	      ...
	      $.each(this.columns, function (i, column) {
	        ...
	        $field.off('save').on('save', function (_ref, _ref2) {
	          ...
	          //TODO @GPO - Se comenta este reinicio ya que provoca que se pierda la posición que se acaba de editar
	          //_this2.initBody();
	        });
